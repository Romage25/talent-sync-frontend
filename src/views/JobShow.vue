...
const jobs = [
  {
    ...
    job_type: "Full Time",
    description:
      "Build scalable APIs using Laravel and maintain backend systems.",
    salary_min: 30000,
    salary_max: 60000,
    requirements: [
      "Laravel experience",
  ...
  },
  {
    ...
    location: "Makati",
    job_type: "Contract",
    description: "Develop modern UI using Vue 3 and TypeScript.",
    salary_min: 25000,
    salary_max: 45000,
    requirements: ["Vue 3", "TypeScript", "Tailwind CSS"],
  },
];
...
<template>
  <div class="max-w-4xl mx-auto p-6">
    ...
    <!-- If job not found -->
    <div v-if="!job" class="text-center text-gray-500">
      Job not found.
    </div>
